...
void main() {
  test('Create event with one player', () {
    Player topSeed = Player(lastName: "Seed", firstName: "top", id: "1", rating: 2342, status: "Ready");
    Event mainEvent = Event(name: "main", location: "Seattle", organizer: "SJ", eventTime: DateTime.now());
